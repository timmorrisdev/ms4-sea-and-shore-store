...
class TestProductViews(TestCase):
    ...
    def setUp(self):
        ...
        self.edit_product_review_url = reverse('edit_product_review', kwargs={'review_id':self.review.id})
        self.delete_product_review_url = reverse('delete_product_review', kwargs={'review_id':self.review.id})
