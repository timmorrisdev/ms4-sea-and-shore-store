...
from . import views
from .views import ProductDetail, AddProduct, EditProduct, DeleteProduct, AddProductVariation
...
urlpatterns = [
    ...
    path('add_product_variation/<slug:product_id>/', AddProductVariation.as_view(), name='add_product_variation'),
    # path('delete_variation/<int:variation_id>/', views.delete_product_variation, name='delete_product_variation'),
]