"""
Django settings for sea_and_shore project.
...
ALLOWED_HOSTS = ['sea-and-shore-store.herokuapp.com', 'localhost', '127.0.0.1']
...
ROOT_URLCONF = 'sea_and_shore.urls'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'product_reviews.contexts.product_reviews',
...
WSGI_APPLICATION = 'sea_and_shore.wsgi.application'
...
if 'USE_AWS' in os.environ:
    ...
    # Bucket Config
    AWS_STORAGE_BUCKET_NAME = 'sea-and-shore-store'
